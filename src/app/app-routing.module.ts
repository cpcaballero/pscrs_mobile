...
const routes: Routes = [
  ...
  {
    path: 'public/connect',
    loadChildren: () => import('./public/connect/connect.module').then(m => m.ConnectPageModule)
  },
  {
  ...
  {
    path: 'public/terms',
    loadChildren: () => import('./public/terms/terms.module').then(m => m.TermsPageModule)
  },
  {
    path: 'public/privacy',
  ...
  },
  {
    ...
    loadChildren: () => import('./member/calendar/calendar.module').then(m => m.CalendarPageModule)
  },
  {
    path: 'member/billing',
    loadChildren: () => import('./member/billing/billing.module').then(m => m.BillingPageModule)
  }
];
